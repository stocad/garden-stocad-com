...
Recently, I've been reading more and more about [Fair code](https://faircode.io/). Open source has the problem that the developers who publish tools under the most open licenses often create very profitable industries that are well capitalized, but the maintainer sees very little of the benefit their labor has produced. It is quite common for developers to receive less than minimum wage, even as masses of eager users fill their Github issues queue to the brim.
